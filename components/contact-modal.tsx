    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-99999 w-full max-w-md mx-4">
        <div className="bg-gradient-to-br from-primary via-secondary to-primary p-8 rounded-2xl shadow-2xl border-2 border-primary-foreground/30 text-center animate-fade-in-up">
          <h3 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">Contáctanos por mail</h3>
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-6 break-all">
            <a href="mailto:chilleatsproject@gmail.com" className="font-bold hover:underline">
              chilleatsproject@gmail.com
            </a>
          </p>
          <button
            onClick={onClose}
